...
var (
	...
	// MongoDbSourceEventTypes represents the different Event Types
	MongoDbSourceEventTypes = []string{
...
type MongoDbSourceSpec struct {
	...
	MongoDbCredentials corev1.ObjectReference `json:"credentials,omitempty"`
