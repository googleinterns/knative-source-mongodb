...
import (
	...
	"github.com/googleinterns/knative-source-mongodb/pkg/reconciler"
	...
	mongodbinformer "github.com/googleinterns/knative-source-mongodb/pkg/client/injection/informers/sources/v1alpha1/mongodbsource"
	"github.com/googleinterns/knative-source-mongodb/pkg/client/injection/reconciler/sources/v1alpha1/mongodbsource"
)

const (
	// ReconcilerName is the name of the reconciler
	ReconcilerName = "MongoDbSource"
)
...
func NewController(
	...
	mongodbSourceInformer := mongodbinformer.Get(ctx)
	...
	r := &Reconciler{
		...
		configAccessor: reconcilersource.WatchConfigurations(ctx, "mongodb-source", cmw),
	}
	if err := envconfig.Process("", r); err != nil {
		logging.FromContext(ctx).Panicf("required environment variable is not defined: %v", err)
	}

	impl := mongodbsource.NewImpl(ctx, r)
